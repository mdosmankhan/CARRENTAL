...
<!--<section id="listing_img_slider">-->
  <div><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" width="450" height="260"></div>
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <div class="tab-content"> 
               vehicle-overview               <div role="tabpanel" class="tab-pane active" id="vehicle-overview">
